...
## Draft
#### API: GET /interactions/{type: signup}/draft
...
#### API: POST /interactions/{type: signup}/{id}/submit
...
#### API: POST  /interactions/{type: signup}/{id}/bind
...
When the user confirms the interaction VIA <Event>BIND</Event> we are entering the <State>verified</State> state . 
